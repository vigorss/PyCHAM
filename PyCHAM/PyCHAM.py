...
class PyCHAM(QWidget):
	...
	def on_click1(self):
		...
		#sch_name = str(os.getcwd() + '/PyCHAM/output/GMD_paper_plotting_scripts/fig06_scheme.txt')
	...
	def on_click3(self):
		...
		#inname = str(os.getcwd() + '/PyCHAM/output/GMD_paper_plotting_scripts/fig06_mod_var.txt')
